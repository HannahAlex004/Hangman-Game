...
string displayWord(const string& secretWord, const vector<char>& guessedLetters) {
 ...
 if (find(guessedLetters.begin(), guessedLetters.end(), lowerCaseLetter) !=
guessedLetters.end()) {
 display += letter;
 } else {
 display += '_';
...
int main() {
 ...
 if (find(guessedLetters.begin(), guessedLetters.end(), guess) !=
guessedLetters.end()) {
 ...
 // Display the result
cout << "Sorry, you've run out of attempts. The correct game was: " << selectedGame.name <<
endl;
cout << "Better luck next time!" << endl;
// Display the correct game description
cout << "Game Description: " << selectedGame.description << endl;
